...
\DoxyCodeLine{40 }
\DoxyCodeLine{53 \textcolor{keyword}{extern} DECLSPEC \textcolor{keywordtype}{int} SDLCALL \mbox{\hyperlink{_s_d_l__clipboard_8h_a36d97ed867cc1a6a4f015aaa5972ed46}{SDL\_SetClipboardText}}(\textcolor{keyword}{const} \textcolor{keywordtype}{char} *text);}
\DoxyCodeLine{54 }
\DoxyCodeLine{71 \textcolor{keyword}{extern} DECLSPEC \textcolor{keywordtype}{char} * SDLCALL \mbox{\hyperlink{_s_d_l__clipboard_8h_a9d0253e99db153d85cbe5e5a3008b1d5}{SDL\_GetClipboardText}}(\textcolor{keywordtype}{void});}
\DoxyCodeLine{72 }
\DoxyCodeLine{83 \textcolor{keyword}{extern} DECLSPEC SDL\_bool SDLCALL \mbox{\hyperlink{_s_d_l__clipboard_8h_a415fa85de093cf6117626a9415394509}{SDL\_HasClipboardText}}(\textcolor{keywordtype}{void});}
\DoxyCodeLine{84 }
\DoxyCodeLine{85 }
